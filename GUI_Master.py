...
heading = tk.Label(root,text="Anomaly Detection System",width=25,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
...
def update_label(str_T):
    # clear_img()
    result_label = tk.Label(root, text=str_T, width=50, font=("bold", 10),bg='cyan',fg='black' )
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model('C:/Anomaly Detection 2/abnormalevent.h5')    #video = cv.VideoCapture(video_path);
...
button5 = tk.Button(root,command = Video_Verify, text="Anomaly Detection System", width=20,font=("Times new roman", 25, "bold"),bg="cyan",fg="black")
