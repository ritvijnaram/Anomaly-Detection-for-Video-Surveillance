...
#
label_l1 = tk.Label(root, text="Anomaly Detection System",font=("Times New Roman", 35, 'bold'),
...
button3 = tk.Button(root, text="Exist",command=window,width=14, height=1,font=('times', 20, ' bold '), bg="#FFEBCD", fg="brown")
